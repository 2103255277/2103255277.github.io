var LANGUAGES = {
    ...
    "en": {
        ...
        texts: {
            "page-title": "进入公子的正确方法：点击下方options然后切换为中文(不要问我为啥那么麻烦，要问就是我不道咋切换语言，呜呜呜)",
            "doc-title": "Kuru Kuru~",
        ...
        texts: {
            "page-title": "公子飞奔",
            "doc-title": "力挽狂澜！",
            "page-descriptions": "给达达利鸭做的小网站，对，就是那个<del>天天立</del>力挽狂澜的反派角色！",
            "counter-descriptions": ["公子已经出现了", "达达利亚已经"],
            "counter-unit": ["次", "次力挽狂澜"],
            "counter-button": ["力挽狂澜！！！", "稍冻鸡翅！"],
            ...
            "repository-desc": "原作者的GitHub 仓库",
            "options-txt-vo-lang": "语音语言",
            "options-txt-lang": "界面语言",
            "dialogs-close": "关闭",
            "dialogs-credits-title": "原制作人员名单",
